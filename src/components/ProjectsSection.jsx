...
import { FolderGit2, Search, ExternalLink, Github, Filter, Loader2 } from 'lucide-react';
      ...
      <div className="max-w-6xl mx-auto">
        ...
        {error && !loading && (
          <div className="text-center py-12">
            <div className="bg-gray-900 rounded-lg p-8 border border-red-500/30 inline-block">
              ...
              <div className="flex items-center space-x-3 overflow-x-auto pb-2">
                ...
                {allTech.map(tech => (
                  <button
                    ...
                    className={`px-4 py-2 rounded-lg font-mono text-sm whitespace-nowrap border transition-colors duration-200 ${
                      selectedTech === tech
